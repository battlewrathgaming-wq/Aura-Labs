# [Project] Project-Local Operational Map
...
| Basis | Used? | Notes |
| --- | --- | --- |
| Source code | TODO | TODO |
| Project docs | TODO | TODO |
| Current packet | TODO | TODO |
| Accepted state | TODO | TODO |
| Human context | TODO | Advisory only; do not use as proof of runtime behavior. |
...
| --- | --- | --- | --- |
| TODO | `code-observed` / `doc-stated` / `accepted-state` | `file path | symbol/section | observed fact | supports claim because` | TODO |
