...
const copySurface = [
  ...
  },
  {
    ...
    strings: [
      ...
      'Band marker',
      'Authority note: no active interval.',
      'Authority window is open for a bounded interval.',
      'Warning: do not imply background behavior.',
      'Display-only handoff marker is available.',
      'Authority interval ended without capture.',
      'Waiting before the next eligible authority window.',
