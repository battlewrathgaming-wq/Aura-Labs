...
| H10 | Lazy-Loaded Visual Slot | Add one deferred visual slot pattern that can load heavier visual treatment only when requested or visible, without changing bridge meaning. | Accepted next bounded candidate after HS112. |
...
| H17 | Reduced-Motion Gate | Add a presentation gate so motion and transitions can be reduced without breaking comprehension. | Accepted in M30. |
